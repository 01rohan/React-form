...
class Toolbar extends React.Component {
        ...
        return [
          {
            value: "place_holder_option_1",
            text: intl.formatMessage({ id: "place-holder-option-1" }),
            key: `bulletlist_option_${ID.uuid()}`,
          },
          {
            value: "place_holder_option_2",
            text: intl.formatMessage({ id: "place-holder-option-2" }),
  ...
  _defaultItems(intl) {
    return [
      ...
      },
      {
        key: "BulletList",
        canHaveAnswer: true,
        name: intl.formatMessage({ id: "multiple-choice-bullet" }),
        icon: "fa fa-list",
        label: intl.formatMessage({ id: "place-holder-label" }),
        field_name: "bulletlist_",
        options: [],
      },
      {
        key: "TextInput",
      ...
      },
      {
        key: "ScaleRating",
        canHaveAnswer: true,
        name: intl.formatMessage({ id: "scale" }),
        label: intl.formatMessage({ id: "place-holder-label" }),
  ...
  renderItem = (item) => (
    <ToolbarItem
      data={item}
      key={item.key}
      onClick={this._onClick.bind(this, item)} // on click it will go to form container//
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <ul style={{ overflow: "scroll", overflowX: "hidden", height: "100%" }}>
